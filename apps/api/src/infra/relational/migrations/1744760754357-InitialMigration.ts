...
export class InitialMigration1744760754357 implements MigrationInterface {
    name = 'InitialMigration1744760754357'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "block" ("id" int NOT NULL IDENTITY(1,1), "blockIndex" int NOT NULL, "text" nvarchar(MAX) NOT NULL, "metadata" nvarchar(MAX) NOT NULL, "documentId" uniqueidentifier NOT NULL, CONSTRAINT "PK_d0925763efb591c2e2ffb267572" PRIMARY KEY ("id"))`);
